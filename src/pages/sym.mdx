...
Two distinct symbols can have identical locations; in particular, <LatestStableLink to="rgbasm.5#Allocating_overlapping_spaces_in_RAM">unions</LatestStableLink> facilitate this.
